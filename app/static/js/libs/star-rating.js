    ...
    Rating.prototype = {
        ...
        init: function (options) {
            ...
            if (self.$rating === undefined && self.$container === undefined) {
                self.$rating = $(document.createElement("span")).html('<span class="rating-stars"></span>');
        ...
        renderClear: function () {
            ...
            return '<span class="' + css + '" title="' + self.clearButtonTitle + '">' + self.clearButton + '</span>';
        },
        renderCaption: function () {
            ...
            return '<span class="caption">' + html + '</span>';
        },
